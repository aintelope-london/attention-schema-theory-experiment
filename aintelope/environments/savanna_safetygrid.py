...
LAYER_ORDER = [GAP_CHR, WALL_CHR, DANGER_TILE_CHR, PREDATOR_NPC_CHR, DRINK_CHR, FOOD_CHR, SMALL_DRINK_CHR, SMALL_FOOD_CHR, GOLD_CHR, SILVER_CHR, AGENT_CHR1, AGENT_CHR2, ALL_AGENTS_LAYER]
# typing aliases
Action = Actions  # int
